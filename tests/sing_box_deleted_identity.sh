...
# A package replacement renames the running executable link rather than
# clearing it. Both spellings are the same owned runtime; anything else is not.
